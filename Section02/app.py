...
def callback_handling():
    ...
    get_token = GetToken('videopackt.auth0.com')
    auth0_users = Users('videopackt.auth0.com')
    token = get_token.authorization_code(os.environ['qQRRdhE7f9UsrWoGwnepnU1pR4GvzqIp'],
                                         os.environ['kF3l3SRwJnVf_S-sG28ACh2CJbYa6ZfyO-Q6v230MVyavd8ax9fvUvUVooDBgT6Y'], code, 'http://localhost:5000/callback')
